    ...
    def _define_tools(self) -> list[AdapterTool]:
        return [
            ...
            AdapterTool(
                name="workspace_read",
                description=(
                    "Read a file or list a directory under the active Oracle workspace. "
                    "Use before answering questions about current source files, local "
                    "project layout, or exact code contents."
                ),
                parameters={
                    "type": "object",
                    "properties": {
                        "path": {
                            "type": "string",
                            "description": "Workspace-relative path, or an absolute path inside the active workspace.",
                        },
                        "max_lines": {
                            "type": "integer",
                            "description": "Maximum file lines to include.",
                            "default": 240,
                            "minimum": 1,
                            "maximum": 1000,
                        },
