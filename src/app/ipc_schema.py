...
class RouteListRequestParams(TypedDict):
    includeHidden: NotRequired[bool]


class RouteSelectRequestParams(TypedDict):
    route: str
    requestId: NotRequired[str]
    probeAfterSelect: NotRequired[bool]


class RouteStatusRequestParams(TypedDict):
    route: NotRequired[str]


class RouteProbeRequestParams(TypedDict):
    route: NotRequired[str]
    prompt: NotRequired[str]
    timeoutMs: NotRequired[int]


class InventoryQueryRequestParams(TypedDict):
    routeNames: NotRequired[list[str]]
    route: NotRequired[str]
...
class InventoryResolveRequestParams(TypedDict):
    ...
    model: NotRequired[str]
    autoLoad: NotRequired[bool]


class InventoryResolveResponseParams(TypedDict):
    alias: str
    canonical_name: str
    model_id: str
    backend: str
...
class CompleteResponseParams(TypedDict):
    text: str
...
class UiEventParams(TypedDict):
    ...
    routeStatus: NotRequired[dict[str, object]]
    inventory: NotRequired[dict[str, object]]
...
REQUEST_METHOD_TYPES: dict[str, tuple[str, type[TypedDict] | None]] = {
    ...
    "complete": ("CompleteRequest", CompleteRequestParams),
    "status": ("StatusRequest", None),
    "models": ("ModelsRequest", None),
    "route/list": ("RouteListRequest", RouteListRequestParams),
    "route/select": ("RouteSelectRequest", RouteSelectRequestParams),
    "route/status": ("RouteStatusRequest", RouteStatusRequestParams),
    "route/probe": ("RouteProbeRequest", RouteProbeRequestParams),
    "inventory/query": ("InventoryQueryRequest", InventoryQueryRequestParams),
...
NOTIFICATION_METHOD_TYPES: dict[str, tuple[str, type[TypedDict] | None]] = {
    ...
    "ui/event": ("UiEventNotification", UiEventParams),
}
...
_TS_TYPE_ORDER: list[type[TypedDict] | object] = [
    ...
    RouteListRequestParams,
    RouteSelectRequestParams,
